        ...
        <section className="container">
            ...
            <div className="projeto__conteudo">
                ...
                <div className="div-descricao">
                    <p className="projeto__descricao">A ideia do projeto surgiu após a professora Célia, docente do IFSP, atuar como voluntária em um evento beneficiente para levantar fundos à APAE no segundo semestre de 2016. Desde então, após visitas e conversas com os coordenadores da APAE, nasce o projeto de dar aulas de informática para os alunos.
                    </p>
